...
<div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
    <div class="col-lg-12 mobile-dashbord dashbord">
     ...
     <div class="dashborad-box mb-0">
         <h4 class="heading pt-0">Thêm mới</h4>
         <div class="section-inforamation">
             <form method="POST" enctype="multipart/form-data" action="{{route('get_admin.location.create_post')}}">
                @csrf
                 <div class="row">
                     <div class="col-sm-6">
                         <div class="form-group">
                             <label style="color: #333;display: inline-block;font-size: 15px;font-weight: 600;text-transform: capitalize;">Tên</label>
                             <input type="text" name="name" class="form-control" placeholder="Tỉnh thành phố">
                         </div>
                     </div>
                     ...
                     <div class="col-sm-6">
                             ...
                             <div class="form-group categories select-container ">
                                <label style="color: #333;display: inline-block;font-size: 15px;font-weight: 600;text-transform: capitalize;">Phân loại</label>
                                <select name="type" id="type" class="nice-select form-control wide">
                                    <option value="1" class="option">--Tỉnh thành--</option>
                                    <option value="2" class="option">--Quận huyện--</option>
                                    <option value="3" class="option">--Phường xã--</option>
                                </select>
                            </div>
                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="form-group categories select-container ">
                           <label style="color: #333;display: inline-block;font-size: 15px;font-weight: 600;text-transform: capitalize;">Tỉnh thành</label>
                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="col-sm-12">
                        <div class="form-group">
                            <input type="radio" name="hot" class="" placeholder="" value="1">
                            <label>Nổi bật</label>
                        </div>
                        <div class="form-group">
                            <input type="radio" name="hot" class="" placeholder="" value="0" checked>

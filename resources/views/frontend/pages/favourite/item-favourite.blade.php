@if(Session::has('Favourite') != null)
                ...
                <div class="project-single mb-0 bb-0" data-aos="fade-up">
                    <div class="project-inner project-head">
                        ...
                        <div class="button-effect">
                            <a onclick="AddFavorite({{$item['roomInfo']->id}})"  href="javascript:" class="img-poppu btn" id="{{$item['roomInfo']->id}}"><i id="icon-heart{{$item['roomInfo']->id}}" class="fa-solid fa-heart"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @endforeach
    {{-- <input type="number" name="" id="total-quanty-favourite" value="{{session::get('Favourite')->totalQuanty}}"> --}}
@endif